...
## (33) The Open Herbarium
spec.dist <- symbiota(taxon = "Biarum straussii", db = "symbhereb")

## (34) Documenting Ethnobiology in Mexico and Central America
spec.dist <- symbiota(taxon = "Salvia longispicata", db = "demca")

## (35) Consortium of Pacific Herbaria
spec.dist <- symbiota(taxon = "Begonia hirtella", db = "Pacific")

## (36) The University of New Hampshire Collection of Insects and Other Arthropods
...
## (37) The Lundell Plant Diversity Portal
